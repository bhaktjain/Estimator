#!/usr/bin/env python3
"""
Create final corrected estimate using internal pricing sheet and takeoff
"""
import csv

def create_final_corrected_estimate():
    """Create final estimate using correct internal pricing and takeoff quantities."""
    
    print("🔧 CREATING FINAL CORRECTED ESTIMATE")
    print("Using INTERNAL PRICING SHEET + TAKEOFF QUANTITIES")
    print("=" * 60)
    
    # Items with CORRECT internal pricing from master sheet + takeoff quantities
    items = [
        # DEMOLITION & PROTECTION - Using DEMO-07 to DEMO-12 rates
        {
            ...
            'Markup': '0.70',     # 70% margin per pricing sheet
            'MarkupType': '%',
            'Total': '178500.00',  # 15000 × $7 × 1.70
            'Confidence': '95'
        },
        
        # FLOORING - Using CORRECT rates from pricing sheet
        {
            'Category': 'Flooring',
            'Room': 'Open Office',
            ...
            'Markup': '0.70',     # 70% margin
            'MarkupType': '%',
            'Total': '88012.50',  # 8625 × $6 × 1.70
            'Confidence': '95'
        },
        {
            'Category': 'Flooring',
        ...
        },
        {
            ...
            'Quantity': '225',
            'UnitCost': '$18.00',  # FINSH-04 rate for tile
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '4590.00',    # 150 × $18 × 1.70
            'Confidence': '95'
        },
        
        # WALLS & CEILINGS - Using CORRECT rates from pricing sheet
        {
            ...
            'Quantity': '700',     # Correct quantity from takeoff
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '56100.00',   # 8250 × $4 × 1.70
            'Confidence': '95'
        },
        
        # WALL FINISHES - Using CORRECT rates from pricing sheet
        {
            ...
            'Quantity': '16800',
            'UnitCost': '$10.30',  # FINSH-05 rate
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '294840.00',  # 16800 × $10.30 × 1.70
            'Confidence': '95'
        },
        {
            'Category': 'Wall Finishes',
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '21060.00',   # 1200 × $10.30 × 1.70
            'Confidence': '95'
        },
        {
            'Category': 'Wall Finishes',
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '7038.00',    # 345 × $12 × 1.70
            'Confidence': '90'
        },
        
        # DOORS & HARDWARE - Using CORRECT rates from pricing sheet
        {
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '8160.00',    # 24 × $200 × 1.70
            'Confidence': '90'
        },
        
        # LIGHTING & ELECTRICAL - Using CORRECT rates from pricing sheet
        {
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '11220.00',   # 15 × $440 × 1.70
            'Confidence': '95'
        },
        
        # PLUMBING FIXTURES - Using CORRECT rates from pricing sheet
        {
        ...
        },
        {
            ...
            'Markup': '0.70',      # 70% margin
            'MarkupType': '%',
            'Total': '2040.00',    # 6 × $200 × 1.70
            'Confidence': '90'
        },
        
        # CUSTOM MILLWORK - Using CORRECT rates from pricing sheet
        {
            ...
            'Markup': '0.60',       # 60% margin per pricing sheet
            'MarkupType': '%',
            'Total': '38400.00',    # 10 × $2400 × 1.60
            'Confidence': '95'
        },
        {
            'Category': 'Custom Millwork',
        ...
        },
        {
            ...
            'Markup': '0.60',       # 60% margin per pricing sheet
            'MarkupType': '%',
            'Total': '7200.00',     # 30 × $150 × 1.60
            'Confidence': '90'
        },
        
        # COUNTERTOPS - Using CORRECT rates from pricing sheet
        {
            ...
            'Markup': '0.75',       # 75% margin per pricing sheet
            'MarkupType': '%',
            'Total': '14028.75',    # 85 × $97 × 1.75
            'Confidence': '95'
        },
        ...
        },
        {
            ...
            'Markup': '0.70',       # 70% margin
            'MarkupType': '%',
            'Total': '3570.00',     # 60 × $35 × 1.70
            'Confidence': '90'
        },
        
        # COMMERCIAL CLEANING - Using CORRECT rates from pricing sheet
        {
            ...
            'Markup': '0.50',       # 50% margin per pricing sheet
            'MarkupType': '%',
            'Total': '6600.00',     # 1 × $4400 × 1.50
            'Confidence': '95'
        }
    ]
...
def main():
    print("🏗️  Creating FINAL CORRECTED 113 University Place Estimate...")
    print("Using ACTUAL INTERNAL PRICING from Master Pricing Sheet")
    print("=" * 60)
    
    items = create_final_corrected_estimate()
    csv_filename = '113_University_Place_Final_Corrected_Estimate.csv'
    ...
    print(f"• Correct painting rates: $10.30/SF (FINSH-05)")
    ...
    print(f"• Correct margins: 50%, 60%, 70% as per pricing sheet")
