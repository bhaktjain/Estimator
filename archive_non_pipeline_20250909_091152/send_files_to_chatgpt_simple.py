"""
send_files_to_chatgpt_simple.py
...
Usage:
  python send_files_to_chatgpt_simple.py --file1 file1.pdf --file2 file2.pdf --file3 file3.txt --prompt "Summarize the key points." [--sample_scope sample1.csv --sample_scope sample2.csv ...] [--api_key sk-proj-...]
